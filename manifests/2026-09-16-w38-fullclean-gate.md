# Integration State: w38-fullclean-gate

## Summary

- Date: 2026-09-16
- Note: full-clean rebuild of the upstream-merged tree: stale-binary census 333->13 (all diagnostic probes), test-libc-pthread 28/0, six-app gate 6/6 + torches PRESENT
...
| --- | --- | --- | --- |
| _build | main | e4dd9656c (dirty(2)) | https://github.com/houp/phoenix-rpi.git |
...
_build	e4dd9656c88a14ea45221f35dc4c70ab20a1ceb6	main
