...
2. [docs/inprogress/WEEK-2026-W38.md](docs/inprogress/WEEK-2026-W38.md) — the CURRENT WEEKLY LOG: decisions needed from the owner, plan for the next days, in-progress work, progress, blocked items. This is the single planning/progress doc (see [docs/inprogress/README.md](docs/inprogress/README.md) for the weekly convention; history is in `docs/done/`)
