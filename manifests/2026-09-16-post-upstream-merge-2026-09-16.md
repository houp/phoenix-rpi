# Integration State: post-upstream-merge-2026-09-16

## Summary

- Date: 2026-09-16
- Note: 17 upstream commits merged (6 repos incl. kernel proc/prio) + gl_stubs pthread_mutex_timedlock stopgap removed; core rebuild clean, startx_gpu boot test 0 faults / desktop 99.0% non-black; all siblings pushed
...
| --- | --- | --- | --- |
| _build | main | 0db378468 (dirty(2)) | https://github.com/houp/phoenix-rpi.git |
| libphoenix | master | 07ebc0b (clean) | https://github.com/phoenix-rtos/libphoenix.git |
...
| phoenix-rtos-devices | master | 411292d (clean) | https://github.com/phoenix-rtos/phoenix-rtos-devices.git |
...
_build	0db378468a18b9089d46a3a462360d6e8bf42193	main
libphoenix	07ebc0b5fa4654eb9d4e6d5835953da59c5fc623	master
...
phoenix-rtos-devices	411292de925e34db37776929b7cb0504959c8bcc	master
