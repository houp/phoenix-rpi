# Integration State: bash-port-formalized

## Summary

- Date: 2026-08-13
- Note: bash 5.2.21 reproducible port (ports f5aa4d4): port.def.sh + patches + config.cache; clean static link, HW-verified execution
...
| --- | --- | --- | --- |
| _build | main | e610647 (dirty(19)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-ports | master | f5aa4d4 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-ports.git |
...
_build	e61064714831766ace861286f19f6af38025da8c	main
...
phoenix-rtos-ports	f5aa4d46f70eb302ae35d1896228f5c95f7fee5d	master
