# Integration State: td16-va-range-investigation

## Summary

- Date: 2026-05-04
- Note: TD-16 cache-enable: 5 fault decode iterations captured via no-call exdump. VA-range helpers in place. Cache parked off until next session restructures PT writes to before SCTLR.M flip
