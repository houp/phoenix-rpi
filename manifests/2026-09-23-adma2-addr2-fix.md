# Integration State: 2026-09-23-adma2-addr2-fix

## Summary

- Date: 2026-09-23
- Note: C7 fixed: ADMA_ADDR_2 (upper half of the ADMA2 system address) was never written, and the resulting stray bus accesses stopped the WiFi chip's firmware loading. One line. Gated with ADMA2 armed: SD 64+0 records read, WiFi fw_alive=1, 0 faults.
...
| --- | --- | --- | --- |
| _build | main | b8b74cbc3 (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
...
_build	b8b74cbc3216ad1e30f9a6af6acd207ab373170a	main
