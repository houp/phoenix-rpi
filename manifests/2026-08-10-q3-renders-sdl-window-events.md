# Integration State: q3-renders-sdl-window-events

## Summary

- Date: 2026-08-10
- Note: SDL_phoenixvideo emits SHOWN/FOCUS window events (ports e498158): fixes Quake III black screen (gw_minimized stuck -> backend skipped); Q3 UI renders on HDMI, 0 faults; quakespasm-sdl no-regression. General SDL-port fix
...
| --- | --- | --- | --- |
| _build | main | 8cda761 (dirty(17)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-devices | master | 454d449 (dirty(2)) | https://github.com/phoenix-rtos/phoenix-rtos-devices.git |
...
| phoenix-rtos-ports | master | e498158 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-ports.git |
...
_build	8cda7611f416dbe53c010e700a1e11765f80ca8f	main
...
phoenix-rtos-devices	454d4497d2fd7c34abb6dc8c858a08819aab6189	master
...
phoenix-rtos-ports	e4981582546eb4e21c515f13ca49e26fc28437c9	master
