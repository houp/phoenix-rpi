# Integration State: torch67-closed

## Summary

- Date: 2026-09-15
- Note: #67 closed 6/6 by rate; malloc large-bin report discriminators; stdlib 93/0 unix-socket 38/0 Host_Init 2.220s
...
| --- | --- | --- | --- |
| _build | main | 5ef9f9478 (dirty(3)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-tests | master | cefdfd5 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-tests.git |
...
_build	5ef9f94787ba0bfbdd511af69049899dc440348a	main
...
phoenix-rtos-tests	cefdfd5c04ef63f5a2fe91bdd09fcb6c69d9e5d5	master
