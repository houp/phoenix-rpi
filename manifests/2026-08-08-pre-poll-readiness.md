# Integration State: 2026-08-08-pre-poll-readiness

## Summary

- Date: 2026-08-08
- Note: known-good v4 root before the poll()-readiness (blocking single-inet poll) kernel+lwip change
...
| --- | --- | --- | --- |
| _build | main | c9d31a2 (dirty(8)) | https://github.com/houp/phoenix-rpi.git |
