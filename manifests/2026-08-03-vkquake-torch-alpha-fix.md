# Integration State: vkquake-torch-alpha-fix

## Summary

- Date: 2026-08-03
- Note: vkQuake torches fixed: no-WSI fb0 scanout uses color-buffer alpha; opaque fullbright alias models (flame.mdl) had alpha~0 and were dropped by scanout. Fix = opaque alias present alpha=1 (vkQuake d3e329c). HW-verified 7/7 map frames render both archway torches as orange flames.
...
| --- | --- | --- | --- |
| _build | main | 2523780 (dirty(10)) | https://github.com/houp/phoenix-rpi.git |
...
_build	25237809019ee68278a34bf03515c8f5618d59a6	main
