# Integration State: 2026-08-08-nfsv3-root-validated

## Summary

- Date: 2026-08-08
- Note: netboot NFS root switched v4->v3 (project c89945a); HW-verified takeover + reads, 0 NFS4ERR
...
| --- | --- | --- | --- |
| _build | main | 4106082 (dirty(10)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-project | master | c89945a (clean) | https://github.com/phoenix-rtos/phoenix-rtos-project.git |
...
_build	4106082ce80a8ca46c1e48824ecb34679cba9e6b	main
...
phoenix-rtos-project	c89945aa39aec772b9c8bfd3e70d470d01b9ad54	master
