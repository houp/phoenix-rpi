# Integration State: c2-signal-frame-guard

## Summary

- Date: 2026-09-23
- Note: C2 fixed: hal_cpuPushSignal frame push guarded against an exhausted user stack; sigbomb 4/4 gates pass, signal+pthread+misc suites green
...
| --- | --- | --- | --- |
| _build | main | 40a40c3f1 (dirty(3)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-kernel | master | 560d1727 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-kernel.git |
...
_build	40a40c3f199d8580a846afab13848cf08f9d35af	main
...
phoenix-rtos-kernel	560d1727f1602f03e52e84d1640d64ba0adfd284	master
