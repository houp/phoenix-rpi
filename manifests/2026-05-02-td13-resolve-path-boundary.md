# Integration State: td13-resolve-path-boundary

## Summary

- Date: 2026-05-02
- Note: TD-13 mutex/atomic wall fixed; new boundary is libphoenix resolve_path(/dev/console) inside psh ttyopen
...
| --- | --- | --- | --- |
| libphoenix | master | fd8d243 (clean) | https://github.com/phoenix-rtos/libphoenix |
...
| phoenix-rtos-devices | master | 7929591 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-devices.git |
...
| phoenix-rtos-utils | master | c787d3b (clean) | https://github.com/phoenix-rtos/phoenix-rtos-utils/ |
...
libphoenix	fd8d2433acf515fbfeac6ebcfc545f60c59b1683	master
...
phoenix-rtos-devices	7929591362b426b5da1cd5087f53e281152393e1	master
...
phoenix-rtos-utils	c787d3b374820ccd45298d38ac79f60d9ab0adb1	master
