# Integration State: sd-lane-ext2-verified

## Summary

- Date: 2026-09-22
- Note: SD card flashed with the current build and booted: 1 KiB ext2 root mounted first try, 0 faults, build-versions match. Closes the gap that all ext2 testing had been on 4 KiB only.
...
| --- | --- | --- | --- |
| _build | main | 6d01f61ba (dirty(2)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-filesystems | master | 786aacd (dirty(1)) | https://github.com/phoenix-rtos/phoenix-rtos-filesystems.git |
...
_build	6d01f61ba3412e277d56ab7bf82c95c36a7ef263	main
