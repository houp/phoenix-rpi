# Integration State: sweep11-adopted

## Summary

- Date: 2026-09-22
- Note: Upstream sweep 11 adopted: libtty locking/API rework + pl011-tty ported (fbcon moved outside tty->lock, FIONREAD rewritten for the caller-provided out-buffer), libphoenix __INLINE + tcsetattr fix, posixsrv pty. Gated: boot + interactive bash + fbcon 0 faults; six-app showcase 6/6 0 faults, torches 19/19, verified visually.
...
| --- | --- | --- | --- |
| _build | main | d8170fd8e (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
| libphoenix | master | 73e26dc (clean) | https://github.com/phoenix-rtos/libphoenix.git |
...
| phoenix-rtos-filesystems | master | 62d513a (clean) | https://github.com/phoenix-rtos/phoenix-rtos-filesystems.git |
...
_build	d8170fd8e50b7818337b06c8d1968931d56a2996	main
libphoenix	73e26dc933ac9b5cf81d86221acd99a99918e04b	master
...
phoenix-rtos-filesystems	62d513a7c78f816dcb8d9f1cd0008f1838519898	master
