# Integration State: xsoak-30min

## Summary

- Date: 2026-09-16
- Note: 31.7-minute X desktop soak on the merged tree: 0 faults, 0 canary/allocator events, desktop still animating at the end (tick-to-tick change 4.32 late vs 5.95 mid), 126 ticks
...
| --- | --- | --- | --- |
| _build | main | a93342f8e (dirty(2)) | https://github.com/houp/phoenix-rpi.git |
...
_build	a93342f8e57c2c01bd96435a4eee4bbc4ad44a12	main
