# Integration State: 2026-09-20-w39-usb-stick-mounts

## Summary

- Date: 2026-09-20
- Note: USB mass storage: xhci bulk + umass fixes; stick enumerates, mounts ext2 and reads correctly on HW
...
| --- | --- | --- | --- |
| _build | main | 34cfb3742 (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-devices | master | 9b80385 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-devices.git |
...
_build	34cfb3742ed69a1bb0477ab40c3ac263dd616bab	main
...
phoenix-rtos-devices	9b80385ffd955b38e123d0c0ca76deabd4b6fc43	master
