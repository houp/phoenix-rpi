# Integration State: 2026-09-23-sd-reflash-adma2

## Summary

- Date: 2026-09-23
- Note: Card reflashed with the day's fixes and the SD lane gated with ADMA2 on the boot path: 1093+1 records at 12.5 MB/s, SD boot mounts ext2 root after 0 tries, SPARSE TEST OK, 0 faults. Card build-versions confirm devices 92844ab / libphoenix 07a0a29 / filesystems 522ecc8 / kernel 20179bfe / ports fd34552.
...
| --- | --- | --- | --- |
| _build | main | 74a589eb4 (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
...
_build	74a589eb4a534a6ac76b78c8bc77667598e8585a	main
