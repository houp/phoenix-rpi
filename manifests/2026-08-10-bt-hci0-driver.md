# Integration State: 2026-08-10-bt-hci0-driver

## Summary

- Date: 2026-08-10
- Note: rpi4-hci /dev/hci0 first-class Bluetooth driver (T-WIFI-BT increment 1); HW-validated: HCI_RESET round-trip through /dev/hci0 + patchram + Inquiry, 0 faults. Standalone-built, not yet plo-integrated
...
| --- | --- | --- | --- |
| _build | main | fdf1b8e (dirty(17)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-devices | master | 8dbc743 (dirty(2)) | https://github.com/phoenix-rtos/phoenix-rtos-devices.git |
...
_build	fdf1b8e31601ee988bf1b16ab198043c936d2234	main
...
phoenix-rtos-devices	8dbc7434c0787991efff27a30becb2b613cae858	master
