# Integration State: 2026-09-19-w38-td19-gated

## Summary

- Date: 2026-09-19
- Note: TD-19: context synchronization before relying on a changed kernel translation (isb at _pmap_mapScratch, _pmap_writeTtl3 kernel-VA only, _pmap_preinit, _pmap_switch ASID_SHARED). Justified by an observed 2026-09-09 halt symbolized to _pmap_writeTtl3:459. Six-app gate td19gate 6/6, 0 faults, torches present.
...
| --- | --- | --- | --- |
| _build | main | 206a33ecd (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-devices | master | 48a3fc3 (dirty(1)) | https://github.com/phoenix-rtos/phoenix-rtos-devices.git |
...
_build	206a33ecd06e6904dc231983709d83380e61f098	main
...
phoenix-rtos-devices	48a3fc39ff00ecaad9f40844d1d8383ec3db8479	master
