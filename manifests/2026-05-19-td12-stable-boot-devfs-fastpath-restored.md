# Integration State: td12-stable-boot-devfs-fastpath-restored

## Summary

- Date: 2026-05-19
- Note: FULLY STABLE boot: TD-12 speed bundle + pl011_thr one-batch fix + sleep(1) restored + devfs fast-path restored (kernel c8a81d5e). Cold-boot race is closed: test-cycle reliably reaches fbcon: ok with only 1 td14 trace (the unavoidable pre-devfs-register lookup). Image SHA 5eec6278c401.
