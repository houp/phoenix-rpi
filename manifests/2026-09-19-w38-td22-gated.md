# Integration State: 2026-09-19-w38-td22-gated

## Summary

- Date: 2026-09-19
- Note: TD-22: _map_find() refuses a hinted address with less room than requested (leaf-only check; the historic guard could not be restored on the descent, where rmaxgap is a subtree maximum). Gated alone because every process start maps through this path. Six-app gate td22gate 6/6, 0 faults, torches present, 0 MAP OVERLAP reports.
...
| --- | --- | --- | --- |
| _build | main | 7c1744734 (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-kernel | master | f4b8ed57 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-kernel.git |
...
_build	7c1744734ca67c13cb32a723917eccdab80741d5	main
...
phoenix-rtos-kernel	f4b8ed572da177406fdbfe9a0bc46350fdd11607	master
