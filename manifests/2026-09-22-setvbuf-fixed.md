# Integration State: setvbuf-fixed

## Summary

- Date: 2026-09-22
- Note: Two setvbuf defects fixed (null buf + size 0 rejected; & for | meant no flags were ever cleared). libc regression after sweep 11: 551 tests, 0 failures across stdio/string/libcache/misc.
...
| --- | --- | --- | --- |
| _build | main | 134bae5c3 (dirty(2)) | https://github.com/houp/phoenix-rpi.git |
...
_build	134bae5c3f0b4f81201263025226dfe1cbba2a73	main
