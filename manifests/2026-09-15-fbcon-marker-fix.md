# Integration State: fbcon-marker-fix

## Summary

- Date: 2026-09-15
- Note: pl011-tty bring-up messages via stderr; fbcon: ok 3/3 (was ~1/3), 0 faults, unix-socket 38/0
...
| --- | --- | --- | --- |
| _build | main | 127d06ddc (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
...
_build	127d06ddc18aea48f1de51ef59c01b79e3aff8b4	main
