# Integration State: w38-fullclean2-gate

## Summary

- Date: 2026-09-16
- Note: second independent gate pass on the fully-rebuilt merged tree: 6/6 mechanical + 6/6 content + 0 faults + torches PRESENT (20/20); merged tree now at 12/12 across two passes, parity with the pre-merge tree
...
| --- | --- | --- | --- |
| _build | main | 4137d8e24 (dirty(2)) | https://github.com/houp/phoenix-rpi.git |
...
_build	4137d8e2432e11ec959df2b5f5b37c3a102a011a	main
