# Integration State: td15-phase1-mboxprobe-clean

## Summary

- Date: 2026-05-02
- Note: TD-15 phase 1: mailbox-buffer drift probe shows td15:OK on real Pi 4 (no drift). Side-finding: ~1000x system slowdown (TD-16)
...
| phoenix-rtos-kernel | agent/rpi4-program-reloc | e79c5515 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-kernel.git |
...
| plo | codex/common-aarch64-platform-makefiles | 6ca2a32 (clean) | https://github.com/phoenix-rtos/plo.git |
...
phoenix-rtos-kernel	e79c55153b7f765e880188d92718a0ec8a137ded	agent/rpi4-program-reloc
...
plo	6ca2a32342ab6f1a2cc6355d203c0fa0c5c2caca	codex/common-aarch64-platform-makefiles
```
