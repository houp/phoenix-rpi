# Integration State: 2026-09-20-w39-usb-stick-working

## Summary

- Date: 2026-09-20
- Note: USB stick: enumerate + mount ext2 + read (sha256 5/5 OK incl 17MiB) + write verified on HW, 0 faults
...
| --- | --- | --- | --- |
| _build | main | 34cfb3742 (dirty(2)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-devices | master | 11a603e (clean) | https://github.com/phoenix-rtos/phoenix-rtos-devices.git |
...
phoenix-rtos-devices	11a603e303d8575eaaef558c04bcc40812b91faa	master
