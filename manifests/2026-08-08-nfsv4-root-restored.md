# Integration State: 2026-08-08-nfsv4-root-restored

## Summary

- Date: 2026-08-08
- Note: reverted netboot root v3->v4 (project 38ff3cb); v4 mount HW-verified reliable; real perf fix = lwip poll()
...
| --- | --- | --- | --- |
| _build | main | 6579f2d (dirty(9)) | https://github.com/houp/phoenix-rpi.git |
...
_build	6579f2d65a54d34695310b9950063b3ee78b7efd	main
