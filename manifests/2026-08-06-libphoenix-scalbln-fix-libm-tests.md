# Integration State: libphoenix-scalbln-fix-libm-tests

## Summary

- Date: 2026-08-06
- Note: libphoenix scalbln/scalblnf |n|>INT_MAX overflow fix (7ca437b) + libc math regression tests for exp2/log2f/erf/erfc/scalbn (phoenix-rtos-tests)
...
| --- | --- | --- | --- |
| _build | main | b91351a (dirty(9)) | https://github.com/houp/phoenix-rpi.git |
...
_build	b91351a64f301fb647c813772b1444ab05134853	main
