...
writes made to it").
⏭ Next: the bench result, then — if it does not reproduce — treat this single capture as the best
evidence yet for the page-level story and instrument accordingly.
