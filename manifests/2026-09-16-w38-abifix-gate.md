# Integration State: w38-abifix-gate

## Summary

- Date: 2026-09-16
- Note: upstream merge (17 commits) fully adopted: one local revert of the CLOCK_REALTIME cond default + all five showcase ports rebuilt against the new phMutexLock ABI; 6/6 mechanical + 6/6 content + 0 faults + torches PRESENT
...
| --- | --- | --- | --- |
| _build | main | 6c0354c5a (dirty(2)) | https://github.com/houp/phoenix-rpi.git |
...
_build	6c0354c5a51173fe0a27c452c5e00da5426e5405	main
