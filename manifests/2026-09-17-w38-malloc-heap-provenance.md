# Integration State: w38-malloc-heap-provenance

## Summary

- Date: 2026-09-17
- Note: malloc guard prints lheap?/freed?; libc stdlib 93/0 + pthread newlocks 8/0 incl. the new mutex mutual-exclusion tests; mtstress 8x100k clean; quakespasm 4269 frames
...
| --- | --- | --- | --- |
| _build | main | b5a80d37c (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
| libphoenix | master | e4f7c65 (clean) | https://github.com/phoenix-rtos/libphoenix.git |
...
| phoenix-rtos-tests | master | f8e0a39 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-tests.git |
...
_build	b5a80d37cadc8c6b5842b10cf1a5df7a7dc27bec	main
libphoenix	e4f7c654589f93a99bfc3d126b0b338e2b29ddb1	master
...
phoenix-rtos-tests	f8e0a3921ac43245952616654680b12a3de20573	master
