# Integration State: bash-runs-crt0-envp-fix

## Summary

- Date: 2026-08-13
- Note: GNU bash 5.2.21 runs on Phoenix/RPi4; libphoenix crt0 passes envp to main (a59c800) + 6 POSIX/wide-char fixes; --scope core image bd62ec1e, netboot 0 faults
...
| --- | --- | --- | --- |
| _build | main | ac62a56 (dirty(19)) | https://github.com/houp/phoenix-rpi.git |
| libphoenix | master | a59c800 (clean) | https://github.com/phoenix-rtos/libphoenix.git |
...
_build	ac62a56862d958379ac887cf35c253d3358c1bb2	main
libphoenix	a59c8008ceaa96654b22a35d38df82da6c628b9e	master
