# Integration State: ext2-delete-path

## Summary

- Date: 2026-09-21
- Note: Delete path: three defects fixed (unlink released no blocks; truncate freed an indirect then allocated a replacement; the destroy path could allocate at all). 8 MiB delete leak 4044 KiB -> 4 KiB; 1 MiB exact. Residue: one block (-3643).
...
| --- | --- | --- | --- |
| _build | main | 1dacb921b (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-filesystems | master | 244f1cf (clean) | https://github.com/phoenix-rtos/phoenix-rtos-filesystems.git |
...
_build	1dacb921b1a6a153774ba79396995f106b3874c9	main
...
phoenix-rtos-filesystems	244f1cf6082de3c1acf94b1d6355c237b42a0704	master
