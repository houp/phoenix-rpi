# Integration State: demo-image-16ad56f9

## Summary

- Date: 2026-09-15
- Note: demo SD image rpi4b-sd-2part-gated-16ad56f9.img: contents PASS + provenance read from the image's own ext2 root; adds the #66 X-restart fix
...
| --- | --- | --- | --- |
| _build | main | c5bc06bdd (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
...
_build	c5bc06bddda83f0771da02a8dcfbb2f178e857ba	main
