# Integration State: 2026-09-19-w38-adma2-default

## Summary

- Date: 2026-09-19
- Note: ADMA2 32-bit scatter-gather is the default SD data path, both directions. All three paths correct: PIO 12.2, SDMA 12.3, ADMA2 12.4 MB/s (coreutils dd, engine confirmed in each log). Root cause of the long-standing 'write-DMA quirk' was the missing emmc2bus BUS-address translation. Six-app gate adma2gate 6/6, 0 faults, torches present, 0 ADMA_ERROR_STATUS.
...
| --- | --- | --- | --- |
| _build | main | b4d7580fd (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-devices | master | 8add880 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-devices.git |
...
_build	b4d7580fd4b894453376d53e1629addbd256abca	main
...
phoenix-rtos-devices	8add880a056ef02667c5dee78b2b8299e1c9fb9d	master
