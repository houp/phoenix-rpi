# Integration State: w38-audio-paced-pwm-init

## Summary

- Date: 2026-09-18
- Note: rpi4-audio: paced PWM init (BERR was set on 100% of boots; now clear). Verified: 12/12 bench boots BERR clear + RNG1=612, six-app gate 6/6 0 faults torches present, Quake II reached SDL audio initialized
...
| --- | --- | --- | --- |
| _build | main | 7a580bc00 (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-devices | master | 11f182a (clean) | https://github.com/phoenix-rtos/phoenix-rtos-devices.git |
...
_build	7a580bc007c00374f24b1c79618d033bd440a65f	main
...
phoenix-rtos-devices	11f182aa6508b47eb3f20cc20bb310e7e0c677fe	master
