# Integration State: post-premain-hunt-clean

## Summary

- Date: 2026-09-13
- Note: Netboot tree restored after the premain-hang localisation attempt: LIBC_STARTUP_TRACE OFF (0 markers in psh, quakespasm, stk -- staged and live). HW-verified: test-libc-unix-socket 38/0 OK, quakespasm reaches Host_Init in 2.211 s.
...
| --- | --- | --- | --- |
| _build | main | 9828e8611 (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
...
_build	9828e861195f1b533b4b190e915cef917b7db830	main
