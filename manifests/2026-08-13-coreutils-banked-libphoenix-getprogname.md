# Integration State: coreutils-banked-libphoenix-getprogname

## Summary

- Date: 2026-08-13
- Note: coreutils banked at gnulib FILE-internal wall (6 modules); libphoenix getprogname+pthread_sigmask (a7abcfd) pushed; --scope core d2282911 clean
...
| --- | --- | --- | --- |
| _build | main | 1f60dcd (dirty(19)) | https://github.com/houp/phoenix-rpi.git |
| libphoenix | master | a7abcfd (clean) | https://github.com/phoenix-rtos/libphoenix.git |
...
_build	1f60dcd6a289405fa7650ba1feedc0ef474d79b7	main
libphoenix	a7abcfd83b81c53deeb8aa7699e7a0b7a523618d	master
