# Integration State: 2026-08-10-b2-kernel-backtrace

## Summary

- Date: 2026-08-09
- Note: aarch64 kernel exception backtrace (B2): pc+lr+x29 FP-walk printed after register dump; -fno-omit-frame-pointer kernel-only; HW-verified via controlled-fault self-test, 0-fault clean boot
...
| --- | --- | --- | --- |
| _build | main | bed619f (dirty(14)) | https://github.com/houp/phoenix-rpi.git |
...
_build	bed619f34f4ad4d4ffb0dd5e6b77d8965b1964bf	main
