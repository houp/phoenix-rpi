# Integration State: 2026-08-10-lwip-getnameinfo-fix

## Summary

- Date: 2026-08-10
- Note: lwip do_getnameinfo OOB-write-on-sz0 fix (dce3067, LOCAL — org push needs the scrubbed cherry-pick, do carefully next heartbeat). Fixes the lwip crash blocking Quake MP #68; with it + the quakespasm slist-skip, MP CONNECTS (handshake+serverinfo+keepalives, 0 faults). Kernel/core unchanged
...
| --- | --- | --- | --- |
| _build | main | 1810701 (dirty(17)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-devices | master | 2487ba8 (dirty(2)) | https://github.com/phoenix-rtos/phoenix-rtos-devices.git |
...
| phoenix-rtos-lwip | master | dce3067 (dirty(4)) | https://github.com/phoenix-rtos/phoenix-rtos-lwip.git |
...
_build	1810701bfbe3a4cebe57ea53a5b2460fd87c5955	main
...
phoenix-rtos-devices	2487ba8c583451144dec67244f286291b88c5be4	master
...
phoenix-rtos-lwip	dce30676deeeffbabc1a76f922e30782b48691ab	master
