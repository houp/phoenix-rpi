...
- the next bounded question is therefore whether this is a generic multi-core handoff problem or a Pi 4-specific one; the next validation step should run generic `virt` with `-smp 4` before changing loader handoff semantics.
