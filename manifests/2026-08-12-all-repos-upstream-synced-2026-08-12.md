# Integration State: all-repos-upstream-synced-2026-08-12

## Summary

- Date: 2026-08-12
- Note: Owner directive: complete upstream sync for consistency. All 16 siblings now current with origin/master. This turn synced doc(ff)/hostutils(ff)/ports(CPE+SPDX metadata)/tests(new libc tests)/project(submodule-superproject, gitlinks kept ours). kernel+libphoenix synced+boot-verified earlier (ec58537b/8ce5976). No boot-image code changed this batch.
...
| --- | --- | --- | --- |
| _build | main | 5fde281 (dirty(18)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-ports | master | 058078c (clean) | https://github.com/phoenix-rtos/phoenix-rtos-ports.git |
...
_build	5fde2813e3abcf6027eb2e7bf9961f04ed340d0b	main
...
phoenix-rtos-ports	058078c0a87f74956f4de34c55eccbc8b53ee39d	master
