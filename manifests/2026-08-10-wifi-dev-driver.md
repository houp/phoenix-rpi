# Integration State: 2026-08-10-wifi-dev-driver

## Summary

- Date: 2026-08-10
- Note: rpi4-wifi /dev/wifi first-class WiFi scanner driver (T-WIFI-BT); HW-validated: fw boot + escan lists real APs via /dev/wifi, daemonized + separate wifi-scan client, 0 faults. Standalone (not in lwip server); lwip netif for join/DHCP is a later step
...
| --- | --- | --- | --- |
| _build | main | 343489a (dirty(17)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-devices | master | b319e97 (dirty(2)) | https://github.com/phoenix-rtos/phoenix-rtos-devices.git |
...
_build	343489a2f9c46f5cd06e22188b04f125c25c9c56	main
...
phoenix-rtos-devices	b319e97c1eb331c897224975fe5fc4dda7d8a5eb	master
