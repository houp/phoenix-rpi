# Integration State: lwip-fionbio-nonblock-fix

## Summary

- Date: 2026-08-10
- Note: lwip FIONBIO fix: non-blocking sockets now work (was always blocking); HW-validated by Quake MP #68 client fully joining + signon 4 in-game
...
| --- | --- | --- | --- |
| _build | main | dfbbb12 (dirty(18)) | https://github.com/houp/phoenix-rpi.git |
...
_build	dfbbb1230735a839aac02fb9bc5da93143149476	main
