# Integration State: demo-image-afd534a7

## Summary

- Date: 2026-09-13
- Note: Refreshed demo image: Mesa/winsys BO-ownership pair fix + libphoenix heap->size guard + STK patches 0014-0019. Gates: contents PASS, QEMU structural PASS, provenance from own ext2 root PASS. Evidence: six-app gate 6/6 content-graded 0 faults 0 corruption; 31 clean STK bench runs 0 corruption events.
...
| --- | --- | --- | --- |
| _build | main | e6568cf65 (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
...
_build	e6568cf6544155793867ec0b72ffc478f58d4467	main
