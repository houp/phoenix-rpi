# Integration State: x-lock-and-kill-test

## Summary

- Date: 2026-09-15
- Note: #66 fixed in xlaunch; kill(pid,0) liveness test 5/5; fbcon marker fix
...
| --- | --- | --- | --- |
| _build | main | ce5f50873 (dirty(3)) | https://github.com/houp/phoenix-rpi.git |
| libphoenix | master | c996bec (clean) | https://github.com/phoenix-rtos/libphoenix.git |
...
_build	ce5f50873b6f5e2d3a3da3a576ce59275e320be0	main
libphoenix	c996becdc8014b4c5cd6b772c24c42780473a737	master
