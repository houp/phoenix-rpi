# Integration State: post-afunix-clean

## Summary

- Date: 2026-09-13
- Note: Netboot tree restored after the premain-hang diagnostic run: AF_UNIX merged kernel, LIBC_STARTUP_TRACE OFF (0 markers in every binary, staged and live), verified on HW: test-libc-unix-socket 38/0 OK, test-libc-stdlib 93/0 OK, 0 faults.
...
| --- | --- | --- | --- |
| _build | main | 81e08691e (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
...
_build	81e08691e16f78ee2c86e77e38fb1a3dec2b4dd1	main
