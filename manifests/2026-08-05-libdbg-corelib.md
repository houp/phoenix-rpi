# Integration State: 2026-08-05-libdbg-corelib

## Summary

- Date: 2026-08-05
- Note: libdbg corelib added (in-process backtrace/watchdog); --scope core + image verify OK, libdbg.a symbols confirmed
...
| --- | --- | --- | --- |
| _build | main | 0a125fb (dirty(12)) | https://github.com/houp/phoenix-rpi.git |
| libphoenix | master | 50f007c (clean) | https://github.com/phoenix-rtos/libphoenix.git |
...
| phoenix-rtos-ports | master | c191d20 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-ports.git |
...
_build	0a125fbec68e347306f138268ca2d608399ff8f8	main
libphoenix	50f007cea907102e1f19fbfed58b01313da1a900	master
...
phoenix-rtos-ports	c191d20f5b4c708049a534794ec554c50178323e	master
