# Integration State: demo-image-b95e983a

## Summary

- Date: 2026-09-16
- Note: SECOND demo SD image rpi4b-sd-2part-gated-b95e983a.img, cut from the upstream-MERGED tree (12/12 across two gate passes): contents + fs + boot-target PASS; vkquake page-flip verified inside the image's ext2 with a negative control. Alternative to da752ac1 (pre-merge), which remains the recommendation because the reel was recorded on that tree.
...
| --- | --- | --- | --- |
| _build | main | caac29f5e (dirty(2)) | https://github.com/houp/phoenix-rpi.git |
...
_build	caac29f5ed1623637613bccaf8ac23a5aa3e3b71	main
