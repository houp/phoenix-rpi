# Integration State: all-verified

## Summary

- Date: 2026-09-22
- Note: Sweep 11 adopted+gated; six GNU tools shipped+verified; 11 ext2 defects fixed with e2fsck clean and the sparse test 11/11 on HW.
...
| --- | --- | --- | --- |
| _build | main | 05e4e93b6 (dirty(2)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-filesystems | master | 786aacd (clean) | https://github.com/phoenix-rtos/phoenix-rtos-filesystems.git |
...
_build	05e4e93b64e58a95ba444e8af0150129728f52b8	main
...
phoenix-rtos-filesystems	786aacd4bcff77fcb94fc36d104e1b888a629b10	master
