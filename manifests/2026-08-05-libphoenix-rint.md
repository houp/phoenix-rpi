# Integration State: 2026-08-05-libphoenix-rint

## Summary

- Date: 2026-08-05
- Note: libphoenix libm rint/nearbyint added; --scope core build+image verify OK, symbols confirmed in libphoenix.a
...
| --- | --- | --- | --- |
| _build | main | f0cd873 (dirty(10)) | https://github.com/houp/phoenix-rpi.git |
| libphoenix | master | d61f4a3 (clean) | https://github.com/phoenix-rtos/libphoenix.git |
...
_build	f0cd873df69026727b0172cc40692728490e06a3	main
libphoenix	d61f4a3fb81bab2667361c31735668e7fc618717	master
