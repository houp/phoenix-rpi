# Integration State: gnu-tools-shipped

## Summary

- Date: 2026-09-22
- Note: grep/sed/tar/gzip/bzip2/xz registered, built and HW-verified by round trip (cmp-identical); +2.8 MB vs busybox 436 KB.
...
| --- | --- | --- | --- |
| _build | main | 36c420a26 (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
...
_build	36c420a26dfdb686b1a0500db1b4a986ce48dfb4	main
