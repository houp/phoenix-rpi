# Integration State: w38-final-gate

## Summary

- Date: 2026-09-15
- Note: six-app gate 6/6 content-graded 0 faults on the tree the demo image 16ad56f9 came from; psh unknown-command path via write(2)
...
| --- | --- | --- | --- |
| _build | main | 2b3b96e33 (dirty(3)) | https://github.com/houp/phoenix-rpi.git |
...
_build	2b3b96e33fb47d9bac3877812f188151ed1b4310	main
