# Integration State: 2026-08-08-lazy-bss-exec-fixed

## Summary

- Date: 2026-08-08
- Note: kernel b446114f: demand-zero anon .bss at exec; HW-verified yquake2 (26MB bss, was silent) now execs+loads; boot 0 faults
...
| --- | --- | --- | --- |
| _build | main | 03874d1 (dirty(10)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-kernel | master | b446114f (clean) | https://github.com/phoenix-rtos/phoenix-rtos-kernel.git |
...
_build	03874d1bf1410732f1836191cedd04972ab1bfb5	main
...
phoenix-rtos-kernel	b446114fd12fcd49d702addb6c2e1d0c9068fddc	master
