# Integration State: 2026-08-08-poll-readiness-single-inet

## Summary

- Date: 2026-08-08
- Note: kernel 9a6d4743 + lwip 67df3d1: single-inet-socket poll blocks in the server until readiness; HW-verified boots+poll+NFS OK; perf-quantify pending
...
| --- | --- | --- | --- |
| _build | main | c9d31a2 (dirty(10)) | https://github.com/houp/phoenix-rpi.git |
| libphoenix | master | 7ca437b (clean) | https://github.com/phoenix-rtos/libphoenix.git |
...
| phoenix-rtos-kernel | master | 9a6d4743 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-kernel.git |
| phoenix-rtos-lwip | master | 00067ac (dirty(4)) | https://github.com/phoenix-rtos/phoenix-rtos-lwip.git |
...
| phoenix-rtos-project | master | 38ff3cb (clean) | https://github.com/phoenix-rtos/phoenix-rtos-project.git |
...
_build	c9d31a2ebd97f3e4054f35a76c88fc26a2e5a650	main
libphoenix	7ca437b69284a872716832e2b2e33e90d8de0925	master
...
phoenix-rtos-kernel	9a6d47433f1dd75605cba73a31ef8c515ac43f9d	master
phoenix-rtos-lwip	00067ac6df6e7cf626cb223740ee1cc322efc49f	master
...
phoenix-rtos-project	38ff3cba5b20cb47bd5dccb700b92c35635fef56	master
