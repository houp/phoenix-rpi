# Integration State: audio-selftest-bound

## Summary

- Date: 2026-09-17
- Note: rpi4-audio boot self-test bailout (devices efac488) — root cause of q2-sdl-openaudio-hang; HW-verified over netboot, healthy self-test path unchanged, Quake II audio init + 6331 frames
...
| --- | --- | --- | --- |
| _build | main | 22423afe0 (dirty(2)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-devices | master | efac488 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-devices.git |
...
_build	22423afe021b86149c9e548b946dae3cd4d8352a	main
...
phoenix-rtos-devices	efac4889bb35d9642e1f948c950819a62c6c6716	master
