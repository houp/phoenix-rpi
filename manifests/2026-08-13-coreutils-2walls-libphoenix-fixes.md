# Integration State: coreutils-2walls-libphoenix-fixes

## Summary

- Date: 2026-08-13
- Note: coreutils build 325->34 (gettime rename + assert re-includable); libphoenix getmntent+assert pushed to org; --scope core b45039f3 netboot 0 faults
...
| --- | --- | --- | --- |
| _build | main | 5784738 (dirty(20)) | https://github.com/houp/phoenix-rpi.git |
| libphoenix | master | d2a2c1f (clean) | https://github.com/phoenix-rtos/libphoenix.git |
...
_build	5784738a3002a7d17070df787d2916e384ee88a9	main
libphoenix	d2a2c1fa58a840ac4a2c1db151b3c5fdfa6d4796	master
